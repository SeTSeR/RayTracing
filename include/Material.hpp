...
public:
        ...
        static Material<T> red_rubber() {
                return Material(Vec((T)0.3, 0.1, 0.1), Vec((T)0.8, 0.1, 0.1, 0.0), 10., 1.0);
        }
        static Material<T> glass() {
                return Material(Vec((T)0.6, 0.7, 0.8), Vec((T)0.0, 0.38, 0.08, 0.54), 125., 1.5);
        }
        static Material<T> mirror() {
                return Material(Vec((T)1.0, 1.0, 1.0), Vec((T)0.0, 0.92, 0.08, 0.0), 1425., 1.0);
        }
